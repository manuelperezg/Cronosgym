...
<head>
    ...
    <body class="page-body  page-fade">
		...
		<form action="change_s_pwd.php" enctype="multipart/form-data" method="POST" role="form" class="form-horizontal form-groups-bordered">
			...
			<div class="form-group">
				<label for="field-1" class="col-sm-3 control-label">Clave secreta:	</label>					
					<div class="col-sm-5">
						<input type="text" name="login_key"  class="form-control"  data-rule-required="true" placeholder="tu clave secreta">
			...
			<div class="form-group">
				<label for="field-1" class="col-sm-3 control-label">Confirmar contraseña :</label>					
					<div class="col-sm-5">
