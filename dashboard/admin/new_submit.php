...
VALUES ('$p_id','$full_name','$mem_type','$date','$total','$paid','$expiry','$invoice','$name_type','$bal','$exp_time','yes')");
    ...
    echo "<head><script>alert('Perfil no agregado, revisa de nuevo');</script></head></html>";
    echo "<meta http-equiv='refresh' content='0; url=new_entry.php'>";
...
?>";
	...
	<body>
		<header>
			...
			<address>
				<p>Cronos GYM</p>
				<p>Av. Emiliano Zapata 74, Pro-hogar, 62765 Emiliano Zapata, Mor.</p>
				<p>Celular:+52 777 301 5122</p><p>www.cronosgym.com ( cronos_gym1@hotmail.com.com)</p><br><p><div id="barcodeTarget" class="barcodeTarget"></div>
