<ul id="main-menu" class="">
    ...
    <li class="active opened active"><a href="index.php"><i class="entypo-gauge"></i><span>Inicio</span></a></li>
	...
	<li><a href="new_health_status.php"><i class="entypo-user-add"></i><span>Estado de Salud</span></a> 	
		...
		<ul>
			...
			<li><a href="change_values.php"><span>Editar detalles de suscripcion</span></a></li>
		</ul>

	<li><a href="new_plan.php"><i class="entypo-box"></i><span>Visión General</span></a>
