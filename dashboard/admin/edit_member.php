...
<head>
    ...
    <body class="page-body  page-fade">
		...
		<h3>Editar detalles de clientes</h3>
		...
		<hr />
			...
			<form action="edit_mem_submit.php" enctype="multipart/form-data" method="POST" role="form" class="form-horizontal form-groups-bordered">
				...
				<div class="form-group">
					<label for="field-1" class="col-sm-3 control-label">Sexo :</label>					
						...
						<select name="sex" id="bbb" data-rule-required="true" class="form-control" value ='<?php echo $sex; ?>'>
							...
							<input type="text" name="height" id="textfield" class="form-control" data-rule-required="true" data-rule-minlength="1" placeholder="Height" onKeyPress="return checkIt(event)" value ='<?php echo $height; ?>' maxlength="3"  style="display:none"> 
						

				<div class="form-group">
					<label for="field-1" class="col-sm-3 control-label">Peso :</label>					
						<div class="col-sm-5">
							<input type="text" name="weight" id="textfield" class="form-control" data-rule-required="true" data-rule-minlength="1" placeholder="Weight" onKeyPress="return checkIt(event)" value ='<?php echo $weight; ?>'  maxlength="3"> En kilogramos
	    				</div>
				</div>

				
							<input type="text" name="nationality" id="nationality" class="form-control" data-rule-required="true" data-rule-minlength="6" value ='<?php echo $nationality; ?>'  placeholder="Nationality" style="display:none">
						

				
							<input type="text" name="contact" id="textfield6" class="form-control" data-rule-required="true" data-rule-minlength="10" placeholder="Escriba su telefono" value ='<?php echo $contact; ?>'  onKeyPress="return checkIt(event)" maxlength="10" style="display:none">
				...
				<div class="form-group">
					<label for="field-1" class="col-sm-3 control-label">E-Mail :</label>					
						<div class="col-sm-5">
							...
							<input type="text" name="facebookaccount" id="facebookaccount" class="form-control" data-rule-required="true" data-rule-minlength="6" value ='<?php echo $facebookaccount; ?>'  placeholder="Facebook Account" style="display:none">
											

			
							<input type="text" name="twitteraccount" id="twitteraccount" class="form-control" data-rule-required="true" data-rule-minlength="6" value ='<?php echo $twitteraccount; ?>'  placeholder="Twitter Account" style="display:none">
				...
				<div class="form-group">
					<label for="field-1" class="col-sm-3 control-label">Notas adicionales :</label>					
						<div class="col-sm-5">
							

							<textarea rows="3" name="notas" id="textfield3" class="form-control"><?php echo $notas;?></textarea>
						</div>
				</div>	

				
							<input type="text" name="previousgym" id="previousgym" class="form-control" data-rule-required="true" data-rule-minlength="6" value ='<?php echo $previousgym; ?>'  placeholder="Previous Gym" style="display:none">
									

				
							<input type="text" name="yearstraining" id="yearstraining" class="form-control" data-rule-required="true" data-rule-minlength="6" value ='<?php echo $yearstraining; ?>'  placeholder="Years Training" style="display:none">
						

			
						<select name="proof" id="bbb" data-rule-required="true" class="form-control" value ='<?php echo $proof; ?>' style="display:none">
							    <option value="">-- Porfavor seleccione --</option>
